...
Use of the DepressionEmo dataset for developing any web application, mobile app, or commercial tool is strictly prohibited without prior written permission.
